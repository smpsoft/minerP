...
start_write_config() {
    ...
    echo "本机防火墙端口13333已经开放，如果还无法连接，请到云服务商控制台操作安全组，放行对应的端口"
    echo "请以访问本机IP:13333"
    echo
    echo "安装完成...守护模式无日志，需要日志的请以nohup ./minerP_3.0.3_linux &方式运行"
    echo
    echo "以下配置文件：/etc/minerP/config.yml，网页端可修改登录密码token"
    echo
    echo "[*---------]"
    sleep 1
    echo "[**--------]"
...
while :; do
    ...
    echo "github下载地址:https://github.com/smpsoft/minerP"
    echo
    echo " 1. 安装MinerProxy"
    echo
    echo " 2. 卸载MinerProxy"
